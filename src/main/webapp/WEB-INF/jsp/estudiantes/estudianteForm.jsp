...
<%-- 			<form:input path="sexo" class="form-control form-control-sm" /> --%>
		...
		<div class="form-group col-md-6 pr-md-3">
				...
				<form:input path="fechaNacimiento" class="form-control form-control-sm" placeholder="dd/mm/aaaa" />
...
<%-- 			<form:input path="gradoMinusvalia" class="form-control form-control-sm" /> --%>
			<select class="form-control form-control-sm" id="gradoMinusvalia" name="gradoMinusvalia">
			  <option selected>---</option>
...
<%-- 		  <form:input path="titulacionUpm" class="form-control form-control-sm" /> --%>
		  <select class="form-control form-control-sm" id="titulacionUpm" name="titulacionUpm">
		...
		<div class="form-group col-md-4 pr-md-3">
			...
			<form:input path="fechaInicio" class="form-control form-control-sm" placeholder="dd/mm/aaaa" />
			<form:errors path="fechaInicio" element="div" id="rojo" />
		</div>
		<div class="form-group col-md-4 pr-md-3">
			<label for="fechaFin"><spring:message code="label.fechaFin" /></label>
			<form:input path="fechaFin" class="form-control form-control-sm" placeholder="dd/mm/aaaa" />
